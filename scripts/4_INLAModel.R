...
# Create dfs for Infestation and IVA model (inf. vector abundance)
    ...
    df <- subset(df, select = c(hhx.id, x, y, long, lat, v.inf, reinf, iva, degree, degree.cat, connected, harmonic, svi, hai, mobility, ethnicity, kin.svi.med, kin.svi.relmed, kin.occ.inf, kin.iva.med))
